    ...
    return (
        <div className="Main">
            <div className="text-center pb-5 pt-5">
                ...
                <h3 class="display-4 p-4">My name is <span style={{ fontFamily: "sans-serif" }}><b>Shikhar Baheti</b></span> and I am a junior computer engineering major at <span style={{ color: "#500000" }}>Texas A&M University.</span></h3>
